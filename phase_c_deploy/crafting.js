...
const RECIPES = {
  ...
  gang_banner:      { id: "gang_banner",      name: "Боевой стяг",        emoji: "🚩", description: "+15% /gsupportbiz.",           reqs: { scrap_metal: 5, gang_emblem: 3, blueprint: 2 }, outputQty: 1, baseCraftTimeMs: 15*60*1000, successChance: 0.85, outputItemId: "craft_gang_banner" },
